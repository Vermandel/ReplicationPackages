...
% WARNING
     oo_.endo_simul(strmatch('b',M_.endo_names,'exact'),550:end) = 0;


        options_.periods			= size(oo_.endo_simul,2)-2;
        perfect_foresight_solver;
        v22 = oo_;
        v22.endo_simul = [v1.endo_simul(:,1:(t1-1)) v22.endo_simul(:,:)] ;

save run_policy1_baseline_borro_2 v22;
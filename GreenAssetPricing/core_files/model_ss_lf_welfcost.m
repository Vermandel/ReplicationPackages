function [y_lf, x_lf, zetaY_tilda_lf, phi_lf, kH_lf, gamma_lf] = model_ss_lf_welfcost(scale_y,zetaY,alpha,xfactor,deltaX,vartheta,kYyratio_lf,kappa,squig,nY_sts,nH_sts,beta,thetaEZ,y_lf, x_lf, zetaY_tilda, phi_lf, kH_lf, gamma_lf,iotaX,iotaE,chi,deltaK)
%MODEL_SS_LF_WELFCOST Summary of this function goes here
%   Detailed explanation goes here

if vartheta ~= 1 || deltaX ~= 0.0021
